/* ================================================
 * PAGE-MIDIA-HOME.JS
 * Participações na Mídia — loop infinito sem clonar
 * ================================================ */
(function () {
  function initMidiaCarousel(root) {
    var viewport = root.querySelector('.midia-home__track-viewport');
    var track = root.querySelector('.midia-home__track');
    var prevBtn = root.querySelector('.midia-home__seta--prev');
    var nextBtn = root.querySelector('.midia-home__seta--next');
  ...
  function init() {
    var carousels = document.querySelectorAll('.midia-home__carousel-wrapper');
